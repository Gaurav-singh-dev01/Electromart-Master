...
import '../../products/airconditioner/AirConditioners.css';
import acbanner1 from '../airconditioner/acimages/acbanner1.avif'
import acbanner2 from '../airconditioner/acimages/acbanner2.avif'
import acbanner3 from '../airconditioner/acimages/acbanner3.avif'
import acbanner4 from '../airconditioner/acimages/acbanner4.avif'
...
import smallcat from '../airconditioner/acimages/Size-Up-Your-Room-1.jpg'
import midcat from '../airconditioner/acimages/Size-Up-Your-Room-1.5-Ton.jpg'
import largecat from '../airconditioner/acimages/Size-Up-Your-Room-Living-Room.jpg'
import budgetmin from '../airconditioner/acimages/For-Your-Budget-below-30000.jpg'
import budgetuppermin from '../airconditioner/acimages/For-Your-Budget-below-30001-40000.jpg'
import budgetmid from '../airconditioner/acimages/For-Your-Budget-below-40001-50000.jpg'
import budgetlarge from '../airconditioner/acimages/For-Your-Budget-Above-50000.jpg'
import splitac from '../airconditioner/acimages/Choose-Your-Type-Split-AC.jpg'
import windowac from '../airconditioner/acimages/Choose-Your-Type-Window-AC.jpg'
import aircooler from '../airconditioner/acimages/Choose-Your-Type-Cooler.jpg'
import inverterac from '../airconditioner/acimages/Inverter-AC-Type.jpg'
import conciousone from '../airconditioner/acimages/For-The-Energy-Conscious-You-3-Star.png'
import concioustwo from '../airconditioner/acimages/For-The-Energy-Conscious-You-5-Star.png'
import bannerfooter from '../airconditioner/acimages/ac-banner-footer.avif'
                        ...
                        <div className='col-lg-12 col-md-12 col-ms-12 col-12'>
                            <div className='element__08976Id'>
                                ...
                                <div className='rhs__98se'>
                                    <Link to='/AirConditionersCollections'> View All <FontAwesomeIcon icon={faChevronRight} style={{ fontSize: 10, marginLeft: 10 }} /></Link>
                                </div>
                            </div>
                        </div>
                        <div className='col-lg-12 col-md-12 col-ms-12 col-12'>
